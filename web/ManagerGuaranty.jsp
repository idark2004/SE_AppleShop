                ...
                <div class="span9">
                    ...
                    <div class="well">
                        <form class="form-horizontal">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="">Order ID <sup>*</sup></label>
                                <div class="controls">
                                    <input type="text" id="" placeholder="abc123">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="">Sending date <sup>*</sup></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="">Expected return date <sup>*</sup></label>
                                <div class="controls">
                                    <input type="date" id="" placeholder="Date">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="">Guarantee Fee <sup>*</sup></label>
                                <div class="controls">
                                    <input type="text" id="" placeholder="Fee">
                                </div>
                            </div>
