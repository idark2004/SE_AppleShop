...
<html>
    ...
    <body>
        <div class="page__order-complete">
            ...
            <div class="nav">
                <div class="topnav">
                    <a href="" class="header-nav__item-active">All</a>
                    <a href="">Mac</a>
                    <a href="">iPad</a>
                    <a href="">iPhone</a>
            ...
            <div class="order-complete__container">
                ...
                <div class="order-detail">
                    ...
                    <div class="order-detail__item orderid">
                        ...
                        <span class="detail orderid-detail">
                            PaosanPalay,Cupertino, California,America
                        </span>
                    </div>
                    <div class="order-detail__item order-date">
                        <span class="tittle order-date__title">Date:</span>
                        <span class="detail order-date__detail">May 4 2021</span>
                    </div>
                    <div class="order-detail__item order-price">
                        <span class="tittle order-price__title">Total:</span>
                        <span class="detail order-price__detail">5000$</span>
                    </div>
                    <div class="order-detail__item order-pmethod">
                        <span class="tittle order-pmethod__title">Payment Method:</span>
                        <span class="detail order-pmethod__detail">Cod</span>
                    </div>
                </div>
                <!-- <table class="table__order-detail">
                    <thead class="table-head__order-detail">
                        <tr class="tittle">
                            <td class="orderid__title">Order ID:</td>
                            <td class="address__address">Address:</td>
                            <td class="order-date__title">Date:</td>
                            <td class="order-pmethod__title">Payment Method:</td>
                            <td class="order-price__title">Total:</td>
                        </tr>
                    </thead>
                    <tbody class="table-body__order-detail">
                        <tr class="detail">
                            <td class="orderid-detail" >011</td>
                            <td class="address-detail">PaosanPalay,Cupertino, California,America</td>
                            <td class="order-date__detail">May 4 2021</td>
                            <td class="order-pmethod__detail">Cod</td>
                            <td class="order-price__detail">5000$</td>
                        </tr>
                    </tbody>        
                </table> -->
            </div>
