<%-- 
    Document   : UserDetailManager
    Created on : Jun 17, 2021, 9:21:56 AM
    Author     : phath
--%>
...
<body>
    ...
    <div class="main-container">
        <button class="tablink" onclick="openPage('UserProfile', this, 'rgb(202, 202, 202)')" id="defaultOpen">User Profile</button>
        <button class="tablink" onclick="openPage('OrderList', this, 'rgb(202, 202, 202)')">Order List</button>
        ...
        <div id="UserProfile" class="tabcontent">
            <div class="user-container">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">${requestScope.USER_DETAIL.name}</h3>
                </div>
                        ...
                        <table class="table table-user-information">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${requestScope.USER_DETAIL.userID}</td>
                                </tr>
                                <tr>
                                    <td>Date of Birth: </td>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>${requestScope.USER_DETAIL.address}</td>
                                    </tr>
                                    <tr>
                                        <td> Email:</td>

                                        <td><a href="mariaozawa@kimochi.com">${requestScope.USER_DETAIL.email}</a></td>
                                    </tr>
                                    <td>Phone Number: </td>

                                    <td>${requestScope.USER_DETAIL.phone}
                                    </td>
                    ...
                    <table class="table orderList-table table-striped align-middle" id="orderList-table" style="width: 95.5%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>14232</td>
                                <td>Shipping</td>
                                <td><a href=""><button  class="btn btn-secondary action-btn">View</button></a><a href=""><button class="btn btn-success action-btn">Done</button></a></td>
                            </tr>
                            <tr>
                                <td>#00000054</td>
                                <td>14/5/2021</td>
