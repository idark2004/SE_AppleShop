<%-- 
    ...
    Created on : Jul 8, 2021, 8:40:19 PM
    Author     : anime
--%>
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <ul class="thumbnails">
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <i class="tag"></i>
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/5.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">115,000,000 VND</span></h4>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <i class="tag"></i>
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/6.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">115,000,000 VND</span></h4>
                                                    </div>
                                            ...
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/7.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">115,000,000 VND</span></h4>
                                                    </div>
                                            ...
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/8.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">1,000,000,000 VND</span></h4>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="item">
                                        <ul class="thumbnails">
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/2.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">115,000,000 VND</span></h4>
                                                    </div>
                                            ...
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details_Manager.html"><img src="themes/images/products/4.jpg" alt=""></a>
                                                    <div class="caption">
                                                        <h5>Product name</h5>
                                                        <h4 style="font-size: smaller;"><a class="btn" href="product_details.html">VIEW</a> <span class="pull-right">115,000,000 VND</span></h4>
                                                    </div>
