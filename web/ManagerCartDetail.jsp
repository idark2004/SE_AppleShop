<%-- 
    Document   : ManagerBillling
    Created on : Jul 8, 2021, 8:03:48 PM
    Author     : anime
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <h3> SHOPPING CART [ <small>3 Item(s) </small>]<a href="products_Manager.html" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>
                    <hr class="soft" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-append"><input class="span1" style="max-width:34px" placeholder="2" size="16" type="text"><button class="btn" type="button"><i class="icon-minus"></i></button><button class="btn" type="button"><i class="icon-plus"></i></button>
                                        <button class="btn btn-danger" type="button"><i class="icon-remove icon-white"></i></button>
                                    </div>
                                </td>
                                <td>100,000 VND</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-append"><input class="span1" style="max-width:34px" placeholder="1" size="16" type="text"><button class="btn" type="button"><i class="icon-minus"></i></button><button class="btn" type="button"><i class="icon-plus"></i></button>
                                        <button class="btn btn-danger" type="button"><i class="icon-remove icon-white"></i></button>
                                    </div>
                                </td>
                                <td>10,000,000 VND</td>
                        ...
                        <tr>
                            <td>
                                <form class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="">Your phone number </label>
                                        <div class="controls">
                                            <input type="text" id="inputPhone" placeholder="0914123456">
                                        </div>
                                    </div>
                    ...
                    <a href="products_Manager.html" class="btn btn-large"><i class="icon-arrow-left"></i> Continue Shopping </a>
