                ...
                <div class="item active">
                    <div class="container">
                        <a href="signupForm.jsp
                           "><img style="width:100%" src="themes/images/carousel/1.png" alt="" /></a>
                    </div>
                </div>
                <div class="item">
                    <div class="container">
            ...
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="well">
                                <h5>CREATE YOUR ACCOUNT</h5><br/> Create new account to receive better service.<br/><br/><br/>
                                ...
                                <div class="well">
                                    ...
                                    <form action="MainController" method="POST">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input class="span3" type="email" id="inputUsername" placeholder="Enter Username" name="email" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="inputPassword1">Password</label>
                                            <div class="controls">
                                                <input type="password" minlength="4" maxlength="10" class="span3" id="inputPassword1" placeholder="Enter Password" name="password" required>
                                            </div>
                                        </div>
                                        <c:if test="${requestScope.LOGIN_ERROR.loginError != null}">
        ...
        <div class="container">
            <div class="row">
                <div class="span3">
                    ...
                    <a href="cartDeatil.jsp">CART</a>
                    <a href="OrderHistoryController?userid=${sessionScope.USER.userID}">ORDER HISTORY</a>
                </div>
                <div class="span3">
                    <h5>INFORMATION</h5>
