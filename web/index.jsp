                        ...
                        <ul id="topMenu" class="nav pull-right">
                            ...
                            <li class=""><a href="contact.html">Contact</a></li>
                                <c:choose>
                                    ...
                                    <c:otherwise>                                    
                                    <li class="">
                                        <a href="register.html" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">Sign Up</span></a>
                                    </li>
                                    <li class="">
                                        ...
                                        <div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false">
                                            ...
                                            <div class="modal-body">
                                                <form action="MainController" class="form-horizontal loginFrm" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="perform" value="Log in">Log in</button>
